...
Depending on the platform setup, the asset may initialize automatically or may need to be manually executed. To manually execute the asset, run the command `./gcp-dataflow-etl.sh` on the terminal.
...
## Explore ETL Processing with Dataflow and BigQuery

This asset enables you to explore ETL processing with Dataflow and BigQuery.
...
This asset enables you to perform the following activities:
 ...
 - Enable APIs
 - Create GCS bucket, BQ dataset and copy files
 - Launch data injestion pipeline
 - Launch data transformation pipeline
 - Launch data enrichment pipeline
